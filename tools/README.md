...
| [`control-matrix-starter-nist-csf2.json`](control-matrix-starter-nist-csf2.json) | Control Matrix | The 106 NIST CSF 2.0 Core subcategories (verbatim, CSWP 29): cluster-specific ones as Local controls in their rows, cluster-neutral ones as 72 shared Umbrella controls. Generated by `scripts/build-csf2.js` from [`mappings/nist-csf-2.0/`](../mappings/nist-csf-2.0/) — edit the mapping, not this file |
