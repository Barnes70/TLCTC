...
- `tlctc` taxonomy: `tlctc:cluster="NN-slug"` (one per distinct cluster in the path) and exclusive `tlctc:entry-cluster="NN-slug"`; descriptions are the v2.5 dictionary strings verbatim, generated by `scripts/build-misp-taxonomy.js`.
