...
```
||[human][@CozyBear→@Target-NGO]|| #9 →[Δt=~6h] #9 →[Δt=~1h] #4 →[Δt=~15m] ||[human][@CozyBear→@Target-NGO]|| #9 →[Δt=~26d] #4 →[Δt=?] #1 →[Δt=?] #1 + [DRE: C]
```
...
| s3-auth-code-exchange | [#4](/clusters/cluster-4.md) |  | ~15m |  |
