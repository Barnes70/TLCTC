...
- **s3-2-root-shell:** 07-09 20:16. Interactive root shell in the customer container; attacker commands execute. Decisive compromise for @Modal-Cust: capability becomes root in the customer container here. s3-1 records its own SRE. Modal's platform and isolation were not compromised.
